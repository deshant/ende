...
public class V_auto_act extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    String autoKey = message.replaceAll("[^\\w\\s]", ""); // for encryption
	    autoKey = kvalue + autoKey;
	    byte[] key_text = null;
	    ...
	    try {
	 		plain_text = message.getBytes("US-ASCII");
	  			...
	  			//eclipse/ADT forced me to implement this block, even if exception is rare/improbable here.
